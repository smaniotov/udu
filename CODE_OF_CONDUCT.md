...
possible violation, email **smaniotov@gmail.com** with a description of what
happened. `udu` is a solo-maintained project: reports go to Vinícius Smanioto,
the same person referred to as "Community Moderators" below, who maintains the
project alone. If your report concerns that person's own conduct, there is no
independent party in this project to escalate to — in that situation, please use
GitHub's own reporting channels instead: [private vulnerability / abuse
reporting through GitHub Support](https://support.github.com/) or [GitHub's
platform-wide abuse reporting](https://docs.github.com/en/site-policy/content-removal-policies/github-abuse-reporting).
A solo project genuinely has no built-in escalation path beyond that, and it's
better to say so plainly than to imply a process that doesn't exist.
